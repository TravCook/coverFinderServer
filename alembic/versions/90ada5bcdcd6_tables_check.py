...
Revision ID: 90ada5bcdcd6
Revises: 6a2769fa19f3
Create Date: 2025-11-03 10:26:28.216836
...
revision: str = '90ada5bcdcd6'
down_revision: Union[str, Sequence[str], None] = '6a2769fa19f3'
...
def upgrade() -> None:
    ...
    op.drop_column('Sports', 'sigmoidIQRSharpness')
    op.drop_column('Sports', 'averageIndex')
    ...
    op.create_index('ix_sport_unique', 'ValueBetSettings', ['bookmaker', 'sport'], unique=True)
...
def downgrade() -> None:
    ...
    op.alter_column('Stats', 'data',
               ...
               type_=postgresql.JSONB(astext_type=sa.Text()),
               nullable=True)
    op.add_column('Sports', sa.Column('prevStatYear', sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('Sports', sa.Column('averageIndex', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True))
    op.add_column('Sports', sa.Column('sigmoidIQRSharpness', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True))
