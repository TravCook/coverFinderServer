...
Revision ID: 8208ae2f56ef
Revises: 4f1ee3ce5a3b
Create Date: 2025-11-08 09:27:23.255354
...
revision: str = '8208ae2f56ef'
down_revision: Union[str, Sequence[str], None] = '4f1ee3ce5a3b'
...
def upgrade() -> None:
    ...
    op.add_column('HyperParams', sa.Column('regression_estimators', sa.Integer(), nullable=False))
    op.add_column('HyperParams', sa.Column('regression_learning_rate', sa.Float(), nullable=False))
    op.add_column('HyperParams', sa.Column('regression_max_depth', sa.Integer(), nullable=False))
    op.add_column('HyperParams', sa.Column('regression_subsample', sa.Float(), nullable=False))
    op.add_column('HyperParams', sa.Column('regression_colsample_bytree', sa.Float(), nullable=False))
    op.add_column('HyperParams', sa.Column('regression_colsample_bylevel', sa.Float(), nullable=False))
    op.add_column('HyperParams', sa.Column('regression_colsample_bynode', sa.Float(), nullable=False))
    op.add_column('HyperParams', sa.Column('regression_reg_alpha', sa.Float(), nullable=False))
    op.add_column('HyperParams', sa.Column('regression_reg_lambda', sa.Float(), nullable=False))
    op.add_column('HyperParams', sa.Column('classification_estimators', sa.Integer(), nullable=False))
    op.add_column('HyperParams', sa.Column('classification_learning_rate', sa.Float(), nullable=False))
    op.add_column('HyperParams', sa.Column('classification_max_depth', sa.Integer(), nullable=False))
    op.add_column('HyperParams', sa.Column('classification_subsample', sa.Float(), nullable=False))
    op.add_column('HyperParams', sa.Column('classification_colsample_bytree', sa.Float(), nullable=False))
    op.add_column('HyperParams', sa.Column('classification_colsample_bylevel', sa.Float(), nullable=False))
    op.add_column('HyperParams', sa.Column('classification_colsample_bynode', sa.Float(), nullable=False))
    op.add_column('HyperParams', sa.Column('classification_reg_alpha', sa.Float(), nullable=False))
    op.add_column('HyperParams', sa.Column('classification_reg_lambda', sa.Float(), nullable=False))
