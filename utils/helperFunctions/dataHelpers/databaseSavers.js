...
const gameDBSaver = async (game, sport, past) => {
    ...
    if (!homeTeam) console.log(`${game.home_team} failed at saving: ${normalizeTeamName(game.home_team, game.sport_key)} OPPONENT ${game.away_team}, ${normalizeTeamName(game.away_team, game.sport_key)}`)
    if (!awayTeam) console.log(`${game.away_team} failed at saving: ${normalizeTeamName(game.away_team, game.sport_key)} OPPONENT ${game.home_team}, ${normalizeTeamName(game.home_team, game.sport_key)}`)
